...
from apps.products.api.inventory_viewset import InventoryViewSet
from apps.products.api.inventory_transaction_viewset import InventoryTransactionViewSet
